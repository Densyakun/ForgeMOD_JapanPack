...
public class TileEntityTataraFurnace extends TileEntityFurnace {
	...
	public void updateEntity()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				TataraFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
